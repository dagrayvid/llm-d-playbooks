...
# Return to the benchmarks folder
...
Deploy vanilla vLLM as the baseline. This uses standard round-robin load balancing across 4 replicas serving `Qwen/Qwen3-0.6B`. The deployment manifests are in the [`vllm/`](vllm/) directory.
