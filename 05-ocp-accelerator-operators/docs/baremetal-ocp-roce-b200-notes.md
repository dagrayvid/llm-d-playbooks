...
### RoCE PF-to-VLAN Mapping

Each PF is on a separate `/24` subnet. All subnets are in the `172.16.0.0/16` range.

| PF             | Subnet            | Gateway         |
|----------------|--------------------|-----------------|
| ens40f0np0     | 172.16.101.0/24   | 172.16.101.254  |
| ens41f0np0     | 172.16.102.0/24   | 172.16.102.254  |
| ens38f0np0     | 172.16.103.0/24   | 172.16.103.254  |
| ens37f0np0     | 172.16.104.0/24   | 172.16.104.254  |
| ens32f0np0     | 172.16.105.0/24   | 172.16.105.254  |
| ens31f0np0     | 172.16.106.0/24   | 172.16.106.254  |
| ens36f0np0     | 172.16.107.0/24   | 172.16.107.254  |
| ens35f0np0     | 172.16.108.0/24   | 172.16.108.254  |
| ens42f0np0     | 172.16.109.0/24   | 172.16.109.254  |
| ens34f0np0     | 172.16.110.0/24   | 172.16.110.254  |

- Each `/24` limits to 254 usable IPs per PF per subnet
- With `PER_NODE_BLOCK_SIZE=20`, supports up to 12 nodes
